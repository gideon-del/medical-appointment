    ...
    return (
        <div className="flex flex-wrap bg-white rounded-2xl py-2 md:px-4 my-6 md:h-48">
            ...
            <div className="mt-5 md:my-auto w-full md:w-1/2 lg:w-1/4 lg:border-r lg:border-r-gray-400 px-5 lg:px-10">
                <h4 className="text-xl font-medium text-gray-400 ">Hospital</h4>
                <p className="truncate font-semibold">{hospital}</p>
            </div>
            <div className="mt-5 md:my-auto w-full md:w-1/2 lg:w-1/4 lg:border-r lg:border-r-gray-400 px-5 lg:px-10">
                <h4 className="text-xl font-medium text-gray-400 ">Department</h4>
                <p className="truncate font-semibold">{department}</p>
            </div>
            <div className="mt-5 mb-5 md:my-auto w-full md:w-1/2 lg:w-1/4 px-5 lg:px-10">
                <h4 className="text-xl font-medium text-gray-400 truncate">Address</h4>
