      ...
      <footer aria-label="Site Footer" className="bg-white font-poppins">
        <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <h1 className="text-bold text-4xl text-[#0E63F4]">
                DocFinder NG
              </h1>
              ...
              <ul className="flex gap-6 mt-8">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-[#0E63F4] transition hover:opacity-75">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              <div>
                <p className="font-medium text-[#0E63F4]">Services</p>
              ...
              <div>
                <p className="font-medium text-[#0E63F4]">Company</p>
              ...
              <div>
                <p className="font-medium text-[#0E63F4]">Legal</p>
